...
export default function SignUp() {
  ...
  const goToOnboarding = () =>
    navigate('/onboarding', { state: { returnTo: getDashboardUrl() } });
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '11px', color: 'rgba(255,255,255,0.25)', lineHeight: 1.6 }}>
                ...
                <Link to="/terms" style={{ color: 'rgba(255,255,255,0.5)', transition: 'color 0.2s' }}
                  ...
                  onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.5)')}>Terms</Link>{' '}and{' '}
                <Link to="/privacy" style={{ color: 'rgba(255,255,255,0.5)', transition: 'color 0.2s' }}
                  onMouseEnter={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.85)')}
                  onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.5)')}>Privacy Policy</Link>.
              </p>
