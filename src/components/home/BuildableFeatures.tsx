import { Cloud, Users, Zap } from 'lucide-react';
import { Card, CardContent } from '@/components/ui/card';

export function BuildableFeatures() {
  return (
    <div className="mx-auto max-w-3xl lg:max-w-5xl px-6 mt-20">
      {/* Section label */}
      <p
        className="text-center text-[11px] uppercase tracking-[0.3em] mb-12"
        style={{ fontFamily: "'Geist', 'DM Sans', sans-serif", color: "rgba(255,255,255,0.22)", fontWeight: 500 }}
      >
        Platform Features
      </p>
          ...
          <CardContent className="relative m-auto size-fit pt-6">
            <div className="relative flex h-24 w-56 items-center">
              ...
              <span
                ...
                style={{ fontFamily: "'Geist', sans-serif", color: 'rgba(255,255,255,0.90)' }}
              >
                1,800+
              </span>
            </div>
        ...
        >
          <CardContent className="pt-6">
            <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border"
              style={{ borderColor: 'rgba(255,255,255,0.08)', '--tw-border-opacity': 1 } as React.CSSProperties}
            >
              <svg className="m-auto h-fit w-24" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  fill="currentColor"
                />
                <g clipPath="url(#clip0_feat_2)">
                  <path
                    d="M44.0209 55.3542C43.1945 54.7639 42.6916 54.0272 42.5121 53.1442C42.3327 52.2611 42.5995 51.345 43.3125 50.3958C50.632 40.3611 59.812 32.5694 70.8525 27.0208C81.8931 21.4722 93.668 18.6979 106.177 18.6979C118.691 18.6979 130.497 21.3849 141.594 26.7587C152.691 32.1326 161.958 39.8936 169.396 50.0417C170.222 51.1042 170.489 52.0486 170.196 52.875C169.904 53.7014 169.401 54.4097 168.688 55C167.979 55.5903 167.153 55.8571 166.208 55.8004C165.264 55.7437 164.438 55.2408 163.729 54.2917C157.236 45.0833 148.885 38.0307 138.675 33.1337C128.466 28.2368 117.633 25.786 106.177 25.7812C94.7257 25.7812 83.9827 28.2321 73.948 33.1337C63.9132 38.0354 55.5903 45.0881 48.9792 54.2917C48.2709 55.3542 47.4445 55.9444 46.5 56.0625C45.5556 56.1806 44.7292 55.9444 44.0209 55.3542ZM126.188 142.656C113.91 139.587 103.875 133.476 96.0834 124.325C88.2917 115.173 84.3959 103.988 84.3959 90.7708C84.3959 84.8681 86.5209 79.9097 90.7709 75.8958C95.0209 71.8819 100.156 69.875 106.177 69.875C112.198 69.875 117.333 71.8819 121.583 75.8958C125.833 79.9097 127.958 84.8681 127.958 90.7708C127.958 94.6667 129.434 97.9439 132.385 100.602C135.337 103.261 138.819 104.588 142.833 104.583C146.847 104.583 150.271 103.256 153.104 100.602C155.938 97.9486 157.354 94.6714 157.354 90.7708C157.354 77.0764 152.337 65.566 142.302 56.2396C132.267 46.9132 120.285 42.25 106.354 42.25C92.4237 42.25 80.441 46.9132 70.4063 56.2396C60.3716 65.566 55.3542 77.0174 55.3542 90.5937C55.3542 93.4271 55.621 96.9687 56.1546 101.219C56.6882 105.469 57.9562 110.427 59.9584 116.094C60.3125 117.156 60.2842 118.101 59.8734 118.927C59.4625 119.753 58.7825 120.344 57.8334 120.698C56.8889 121.052 55.9752 121.024 55.0921 120.613C54.2091 120.202 53.5881 119.522 53.2292 118.573C51.4584 113.969 50.1905 109.395 49.4255 104.853C48.6605 100.31 48.2756 95.6158 48.2709 90.7708C48.2709 75.0694 53.9682 61.9062 65.363 51.2812C76.7577 40.6562 90.3624 35.3437 106.177 35.3437C122.115 35.3437 135.809 40.6562 147.26 51.2812C158.712 61.9062 164.438 75.0694 164.438 90.7708C164.438 96.6736 162.343 101.601 158.155 105.554C153.966 109.506 148.859 111.485 142.833 111.49C136.813 111.49 131.649 109.513 127.342 105.561C123.035 101.608 120.88 96.6783 120.875 90.7708C120.875 86.875 119.43 83.5978 116.54 80.9392C113.65 78.2805 110.196 76.9536 106.177 76.9583C102.163 76.9583 98.7089 78.2876 95.8142 80.9462C92.9195 83.6049 91.4745 86.8797 91.4792 90.7708C91.4792 102.222 94.8745 111.785 101.665 119.458C108.456 127.132 117.22 132.503 127.958 135.573C129.021 135.927 129.729 136.517 130.083 137.344C130.438 138.17 130.497 139.056 130.26 140C130.024 140.826 129.552 141.535 128.844 142.125C128.135 142.715 127.25 142.892 126.188 142.656Z"
                    fill="url(#paint0_feat_2)"
                  />
                </g>
                <path d="M3 72H209" stroke="#7c3aed" strokeWidth="6" strokeLinecap="round" />
                <defs>
                  <linearGradient id="paint0_feat_2" x1="106.385" y1="1.34375" x2="106" y2="72" gradientUnits="userSpaceOnUse">
                    <stop stopColor="white" stopOpacity="0" />
                    <stop offset="1" stopColor="#7c3aed" />
                  </linearGradient>
                  <clipPath id="clip0_feat_2">
            ...
            <div className="relative z-10 mt-6 space-y-2 text-center">
              ...
              <p style={{ fontFamily: "'Geist', 'DM Sans', sans-serif", fontSize: 14, color: 'rgba(255,255,255,0.38)', lineHeight: 1.6 }}>
                Rate-limited commands, sanitized inputs, and zero exposed secrets — every bot ships ready.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-6">
            <div className="pt-6 lg:px-6">
              <svg className="w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g clipPath="url(#clip0_feat_3)">
                  <circle style={{ color: 'rgba(255,255,255,0.08)' }} cx="29" cy="29" r="15" fill="currentColor" />
                ...
                />
                <defs>
                  <linearGradient id="paint0_feat_3" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                    <stop stopColor="rgba(109,40,217,0.25)" />
                    <stop offset="1" stopColor="rgba(109,40,217,0.02)" />
                  </linearGradient>
                  <clipPath id="clip0_feat_3">
            ...
            <div className="relative z-10 mt-14 space-y-2 text-center">
              ...
              <p style={{ fontFamily: "'Geist', 'DM Sans', sans-serif", fontSize: 14, color: 'rgba(255,255,255,0.38)', lineHeight: 1.6 }}>
                Command usage, active users, and uptime — all tracked in your dashboard.
              </p>
            </div>
          </CardContent>
        </Card>

        {/* ── Card 4: Cloud hosting ─────────────────────────────────────────── */}
        <Card
        ...
        >
          <CardContent className="grid pt-6 sm:grid-cols-2">
            <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
              ...
              >
                <Cloud className="m-auto size-5" strokeWidth={1} style={{ color: 'rgba(255,255,255,0.6)' }} />
              </div>
              <div className="space-y-2">
                ...
                <p style={{ fontFamily: "'Geist', 'DM Sans', sans-serif", fontSize: 14, color: 'rgba(255,255,255,0.38)', lineHeight: 1.6 }}>
                  One-click deploy to dedicated infrastructure. No servers, no Docker configs, no downtime headaches.
                </p>
              </div>
            </div>
            <div
              className="relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6"
              style={{ borderColor: 'rgba(255,255,255,0.06)', borderRadius: '8px 0 0 0' }}
            >
              <div className="absolute left-3 top-2 flex gap-1">
                <span className="block size-2 rounded-full" style={{ background: 'rgba(255,255,255,0.12)', border: '1px solid rgba(255,255,255,0.08)' }}></span>
                <span className="block size-2 rounded-full" style={{ background: 'rgba(255,255,255,0.12)', border: '1px solid rgba(255,255,255,0.08)' }}></span>
                <span className="block size-2 rounded-full" style={{ background: 'rgba(255,255,255,0.12)', border: '1px solid rgba(255,255,255,0.08)' }}></span>
              </div>
              <div className="mt-4 space-y-2 font-mono text-[11px]" style={{ color: 'rgba(255,255,255,0.35)' }}>
                <div className="flex items-center gap-2">
                  <span style={{ color: '#22c55e' }}>●</span>
                  <span>MusicBot <span style={{ color: 'rgba(255,255,255,0.22)' }}>— online · 12d uptime</span></span>
                </div>
                <div className="flex items-center gap-2">
                  <span style={{ color: '#22c55e' }}>●</span>
                  <span>ModGuard <span style={{ color: 'rgba(255,255,255,0.22)' }}>— online · 5d uptime</span></span>
                </div>
                <div className="flex items-center gap-2">
                  <Zap className="w-3 h-3" style={{ color: '#a78bfa' }} />
                  <span>Deploying <span style={{ color: '#a78bfa' }}>WelcomeBot</span><span style={{ color: 'rgba(255,255,255,0.22)' }}>…</span></span>
                </div>
                <div className="flex items-center gap-2">
                  <span style={{ color: 'rgba(255,255,255,0.18)' }}>○</span>
                  <span>LevelBot <span style={{ color: 'rgba(255,255,255,0.22)' }}>— queued</span></span>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="grid h-full pt-6 sm:grid-cols-2">
            <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
              <div
                ...
                style={{ borderColor: 'rgba(255,255,255,0.10)' }}
              >
                <Users className="m-auto size-6" strokeWidth={1} style={{ color: 'rgba(255,255,255,0.6)' }} />
              </div>
              <div className="space-y-2">
                <h2
                  className="text-lg font-medium"
                ...
                <p style={{ fontFamily: "'Geist', 'DM Sans', sans-serif", fontSize: 14, color: 'rgba(255,255,255,0.38)', lineHeight: 1.6 }}>
                  2,400+ builders sharing templates, getting help, and shipping bots together.
                </p>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                  <span
                    className="block h-fit rounded px-2 py-1 text-xs"
                    style={{ border: '1px solid rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.5)', fontFamily: "'Geist', sans-serif" }}
                  >
                    james_b
                  </span>
                  <div className="size-7 ring-4" style={{ '--tw-ring-color': 'transparent' } as React.CSSProperties}>
                    <img
                      className="size-full rounded-full object-cover"
                      src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=56&h=56&fit=crop&crop=face"
                      alt="james"
                    />
                  </div>
                </div>
                ...
                <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                  ...
                  <div className="size-7">
                    <img
                      className="size-full rounded-full object-cover"
                      src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=56&h=56&fit=crop&crop=face"
                      alt="dan"
                    />
                  </div>
                </div>
